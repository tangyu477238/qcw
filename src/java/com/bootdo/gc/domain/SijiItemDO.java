...
public class SijiItemDO implements Serializable {
	...
	//件数
	@Excel(name = "件数", orderNum = "6",isImportField = "packnum")
	...
	//吨数
	@Excel(name = "吨数", orderNum = "7",isImportField = "tonnage")
	private BigDecimal tonnage;
	//基价
	@Excel(name = "基价", orderNum = "8",isImportField = "baseprice")
	private BigDecimal baseprice;
	//系数
	@Excel(name = "系数", orderNum = "9",isImportField = "coefficient")
	private BigDecimal coefficient;
	//运率
	@Excel(name = "运率", orderNum = "10",isImportField = "tranrate")
	private BigDecimal tranrate;
	//运费
	@Excel(name = "运费", orderNum = "11",isImportField = "trancost")
